...
namespace Harmony.Toolkit {
		...
		private static string[] m_iconNames =
    {
		...
		private void OnGUI() {
			...
			//var a= EditorGUIUtility.LoadRequired("Previews/PreviewTransparentMaterial.mat") as Material;
			foreach( var n in m_iconNames ) {
				...
				var a = GUI.backgroundColor;
				GUI.backgroundColor = Color.gray;
				GUILayout.Box( tex, GUILayout.MaxWidth( 100 ) );
				GUI.backgroundColor = a;
				//GUILayout.Box( tex, (GUIStyle) ""/*, GUILayout.MaxWidth( 100 )*/ );
				//Rect textureRect = GUILayoutUtility.GetRect( image.width, image.width, image.height, image.height, GUILayout.ExpandHeight( false ), GUILayout.ExpandWidth( false ) );
				//GUI.Box( textureRect, "" );
				//EditorGUI.DrawTextureTransparent( textureRect, image, ScaleMode.ScaleToFit );
				//EditorGUI.DrawPreviewTexture( textureRect, image, a );
